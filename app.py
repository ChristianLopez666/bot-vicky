...
class VickyBot:
    ...
    def handle_general_flow(self, user_id, user_message):
        ...
        if user_message == '1' or user_message == '5':
            # Iniciar directamente el flujo IMSS con beneficios
            session['campaign'] = 'imss'
            session['state'] = 'show_benefits'
            return self.show_imss_benefits()
        elif user_message == '2':
            ...
            # Si detecta un número, iniciar flujo IMSS directamente con beneficios
    ...
    def show_imss_benefits(self):
        """Muestra los beneficios del préstamo IMSS y nómina Inbursa"""
        benefits_message = """💳 *PRÉSTAMOS IMSS PARA PENSIONADOS* 💳

*¡Obtén hasta $650,000 con tu pensión IMSS!*
...
🏦 *BENEFICIOS ADICIONALES AL CAMBIAR TU NÓMINA A INBURSA:*
💳 Tarjeta de débito sin costo mensual
🛡️ Seguro de vida sin costo
📱 Banca móvil sin comisiones
💲 Cashback en comercios
🔐 Protección contra fraudes

*Para obtener estos beneficios adicionales, necesitas cambiar tu nómina a Inbursa.*
...
¿Cuál es tu pensión mensual aproximada?"""
    ...
    def handle_imss_flow(self, user_id, user_message):
        ...
        if session['state'] == 'show_benefits':
        ...
        # Si viene de welcome con mensaje numérico, procesar directamente
        ...
        # Estado: Preguntar pensión mensual (fallback)
        ...
        # Estado: Preguntar monto del préstamo
            ...
            if amount:
                ...
                if meets_requirements:
                    ...
                    nomina_benefits = """
🏦 *BENEFICIOS AL CAMBIAR TU NÓMINA:*
💳 Tarjeta de débito sin costo
🛡️ Seguro de vida gratuito
📱 App sin comisiones
💲 Cashback en compras
🔐 Protección antifraude

¿Aceptas cambiar tu nómina a Inbursa para activar estos beneficios? (sí/no)"""
                    
                    return f"✅ *¡APROBADO!* Calificas para un préstamo de *${amount:,.2f}*\n\n{nomina_benefits}"
                else:
                    ...
                    return "❌ *En este momento no cumples con los requisitos* para el préstamo IMSS solicitado.\n\nPero tenemos otros servicios que te pueden interesar:\n\n🏦 INBURSA\n1. Préstamos IMSS\n2. Créditos empresariales\n\nEscribe el número de tu opción:"
            else:
        ...
        # Estado: Confirmar cambio de nómina
            ...
            if response_type == 'positive':
                ...
                if user_id in self.user_sessions:
                    del self.user_sessions[user_id]
                return "🎉 *¡FELICIDADES!*\n\n✅ Préstamo aprobado: ${:,.2f}\n✅ Nómina Inbursa: ACTIVADA\n✅ Beneficios: ACTIVADOS\n\nChristian te contactará en los próximos minutos para finalizar tu trámite y explicarte todos tus beneficios.".format(session['data']['loan_amount'])
                ...
                if user_id in self.user_sessions:
                    del self.user_sessions[user_id]
                return "📞 *Solicitud registrada*\n\nHemos registrado tu interés en el préstamo de ${:,.2f}. Christian te contactará pronto con las opciones disponibles.\n\n¡Gracias por tu interés!".format(session['data']['loan_amount'])
            else:
                return "Por favor responde con *'sí'* o *'no'*: ¿Aceptas cambiar tu nómina a Inbursa para activar los beneficios adicionales?"
...
@app.route('/')
def home():
    return "Vicky Bot Running - Embudo IMSS con Beneficios"
